...
/**
*/
module.exports.MessageType = Object.freeze({ AUTODETECT: 0, 0: 'AUTODETECT', REQUEST: 1, 1: 'REQUEST', RESPONSE: 2, 2: 'RESPONSE' })
/**
*/
module.exports.Connection = Object.freeze({ KEEPALIVE: 0, 0: 'KEEPALIVE', CLOSE: 1, 1: 'CLOSE', UPGRADE: 2, 2: 'UPGRADE' })
/**
*/
module.exports.Method = Object.freeze({ ACL: 0, 0: 'ACL', BASELINE_CONTROL: 1, 1: 'BASELINE_CONTROL', BIND: 2, 2: 'BIND', CHECKIN: 3, 3: 'CHECKIN', CHECKOUT: 4, 4: 'CHECKOUT', CONNECT: 5, 5: 'CONNECT', COPY: 6, 6: 'COPY', DELETE: 7, 7: 'DELETE', GET: 8, 8: 'GET', HEAD: 9, 9: 'HEAD', LABEL: 10, 10: 'LABEL', LINK: 11, 11: 'LINK', LOCK: 12, 12: 'LOCK', MERGE: 13, 13: 'MERGE', MKACTIVITY: 14, 14: 'MKACTIVITY', MKCALENDAR: 15, 15: 'MKCALENDAR', MKCOL: 16, 16: 'MKCOL', MKREDIRECTREF: 17, 17: 'MKREDIRECTREF', MKWORKSPACE: 18, 18: 'MKWORKSPACE', MOVE: 19, 19: 'MOVE', OPTIONS: 20, 20: 'OPTIONS', ORDERPATCH: 21, 21: 'ORDERPATCH', PATCH: 22, 22: 'PATCH', POST: 23, 23: 'POST', PRI: 24, 24: 'PRI', PROPFIND: 25, 25: 'PROPFIND', PROPPATCH: 26, 26: 'PROPPATCH', PUT: 27, 27: 'PUT', REBIND: 28, 28: 'REBIND', REPORT: 29, 29: 'REPORT', SEARCH: 30, 30: 'SEARCH', TRACE: 31, 31: 'TRACE', UNBIND: 32, 32: 'UNBIND', UNCHECKOUT: 33, 33: 'UNCHECKOUT', UNLINK: 34, 34: 'UNLINK', UNLOCK: 35, 35: 'UNLOCK', UPDATE: 36, 36: 'UPDATE', UPDATEREDIRECTREF: 37, 37: 'UPDATEREDIRECTREF', VERSION_CONTROL: 38, 38: 'VERSION_CONTROL', DESCRIBE: 39, 39: 'DESCRIBE', GET_PARAMETER: 40, 40: 'GET_PARAMETER', PAUSE: 41, 41: 'PAUSE', PLAY: 42, 42: 'PLAY', PLAY_NOTIFY: 43, 43: 'PLAY_NOTIFY', REDIRECT: 44, 44: 'REDIRECT', SETUP: 45, 45: 'SETUP', SET_PARAMETER: 46, 46: 'SET_PARAMETER', TEARDOWN: 47, 47: 'TEARDOWN', PURGE: 48, 48: 'PURGE' })
/**
*/
module.exports.State = Object.freeze({ START: 0, 0: 'START', FINISH: 1, 1: 'FINISH', ERROR: 2, 2: 'ERROR', MESSAGE: 3, 3: 'MESSAGE', END: 4, 4: 'END', REQUEST: 5, 5: 'REQUEST', REQUEST_METHOD: 6, 6: 'REQUEST_METHOD', REQUEST_URL: 7, 7: 'REQUEST_URL', REQUEST_PROTOCOL: 8, 8: 'REQUEST_PROTOCOL', REQUEST_VERSION: 9, 9: 'REQUEST_VERSION', RESPONSE: 10, 10: 'RESPONSE', RESPONSE_VERSION: 11, 11: 'RESPONSE_VERSION', RESPONSE_STATUS: 12, 12: 'RESPONSE_STATUS', RESPONSE_REASON: 13, 13: 'RESPONSE_REASON', HEADER_NAME: 14, 14: 'HEADER_NAME', HEADER_TRANSFER_ENCODING: 15, 15: 'HEADER_TRANSFER_ENCODING', HEADER_CONTENT_LENGTH: 16, 16: 'HEADER_CONTENT_LENGTH', HEADER_CONNECTION: 17, 17: 'HEADER_CONNECTION', HEADER_VALUE: 18, 18: 'HEADER_VALUE', HEADERS: 19, 19: 'HEADERS', BODY: 20, 20: 'BODY', TUNNEL: 21, 21: 'TUNNEL', BODY_VIA_CONTENT_LENGTH: 22, 22: 'BODY_VIA_CONTENT_LENGTH', BODY_WITH_NO_LENGTH: 23, 23: 'BODY_WITH_NO_LENGTH', CHUNK_LENGTH: 24, 24: 'CHUNK_LENGTH', CHUNK_EXTENSION_NAME: 25, 25: 'CHUNK_EXTENSION_NAME', CHUNK_EXTENSION_VALUE: 26, 26: 'CHUNK_EXTENSION_VALUE', CHUNK_EXTENSION_QUOTED_VALUE: 27, 27: 'CHUNK_EXTENSION_QUOTED_VALUE', CHUNK_DATA: 28, 28: 'CHUNK_DATA', CHUNK_END: 29, 29: 'CHUNK_END', CRLF_AFTER_LAST_CHUNK: 30, 30: 'CRLF_AFTER_LAST_CHUNK', TRAILER_NAME: 31, 31: 'TRAILER_NAME', TRAILER_VALUE: 32, 32: 'TRAILER_VALUE' })
/**
*/
module.exports.Error = Object.freeze({ NONE: 0, 0: 'NONE', UNEXPECTED_DATA: 1, 1: 'UNEXPECTED_DATA', UNEXPECTED_EOF: 2, 2: 'UNEXPECTED_EOF', CALLBACK_ERROR: 3, 3: 'CALLBACK_ERROR', UNEXPECTED_CHARACTER: 4, 4: 'UNEXPECTED_CHARACTER', UNEXPECTED_CONTENT_LENGTH: 5, 5: 'UNEXPECTED_CONTENT_LENGTH', UNEXPECTED_TRANSFER_ENCODING: 6, 6: 'UNEXPECTED_TRANSFER_ENCODING', UNEXPECTED_CONTENT: 7, 7: 'UNEXPECTED_CONTENT', UNTRAILERS: 8, 8: 'UNTRAILERS', INVALID_VERSION: 9, 9: 'INVALID_VERSION', INVALID_STATUS: 10, 10: 'INVALID_STATUS', INVALID_CONTENT_LENGTH: 11, 11: 'INVALID_CONTENT_LENGTH', INVALID_TRANSFER_ENCODING: 12, 12: 'INVALID_TRANSFER_ENCODING', INVALID_CHUNK_SIZE: 13, 13: 'INVALID_CHUNK_SIZE', MISSING_CONNECTION_UPGRADE: 14, 14: 'MISSING_CONNECTION_UPGRADE', UNSUPPORTED_HTTP_VERSION: 15, 15: 'UNSUPPORTED_HTTP_VERSION' })
/**
*/
class Parser {
  static __wrap (ptr) {
...
module.exports.__wbg_call_4c92f6aec1e1d6e6 = function () {
